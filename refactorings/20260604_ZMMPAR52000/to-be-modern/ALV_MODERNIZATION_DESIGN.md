...
> 📌 **진입 화면 = 0400**: 메인 프로그램 `DISPLAY_DATA` → `CALL SCREEN 400`. 화면 0100은 현재 흐름에서 `CALL SCREEN 100`이 없어 **미사용**(MAIN CASE에 0100도 포함되어 있어 무해). 팝업 0200/0300/0500은 `CALL SCREEN … STARTING AT`.
